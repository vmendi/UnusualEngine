package away3d.materials
{
	...
	public class EnviroColorMaterial extends EnviroShader implements ITriangleMaterial
	{
        ...
        */
		...
		{
			tri.source.session.renderTriangleBitmap(_colorMap, getMapping(tri.source as Mesh, tri.faceVO.face), tri.screenVertices, tri.screenIndices, tri.startIndex, tri.endIndex, smooth, false);
