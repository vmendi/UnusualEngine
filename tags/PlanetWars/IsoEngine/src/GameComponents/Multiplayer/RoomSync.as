package GameComponents.Multiplayer
{
	...
	public final class RoomSync extends GameComponent
	{
		...
		private function OnJoinRoom(event:SFSEvent):void
		{
			...
			var playerCharSync : CharacterSync = TheGameModel.CreateSceneObjectFromMovieClip("AvatarChica", "CharacterSync") as CharacterSync;

			// Para que envie eventos de navegación y demás...
			playerCharSync.StartSynchronizing();
