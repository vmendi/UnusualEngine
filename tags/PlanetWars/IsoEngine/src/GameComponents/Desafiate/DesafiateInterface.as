package GameComponents.Desafiate
{
	...
	public final class DesafiateInterface extends GameComponent
	{
		...
		override public function OnStart():void
		{
			...
			TheVisualObject.btConferencias.addEventListener(MouseEvent.CLICK, OnGotoConferencias);
		...
		private function OnGotoConferencias(e:MouseEvent) : void
		{
			TheGameModel.TheIsoEngine.Load("Maps/Desafiate/Conferencias.xml");
		}		
