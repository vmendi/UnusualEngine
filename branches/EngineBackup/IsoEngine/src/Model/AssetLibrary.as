package Model
{
	...
	public class AssetLibrary extends EventDispatcher
	{
		...
		private function FindAssetBundleByImportURL(importURL:String):AssetBundle
		{
			var ret : AssetBundle = null;
			for each(var bundle : AssetBundle in mBundles)
			{
				if (bundle.ImportURL == importURL)
				{
					ret = bundle;
					break;
				}
		...
		{
			if (FindAssetBundleByImportURL(url) != null)
				return;
