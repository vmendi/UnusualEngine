package PathFinding
{
	...
	public class AStar
	{
		...
		private static const DISTANCE_FACTOR:Number = 0.1;
		...
		public function Solve(start:IntPoint, goal:IntPoint):Array
		{
			...
			currentNode.h = DistEuclidian(currentNode, mGoal);
			...
			while (!solved)
			{
				...
				for (var c:int=0; c < 8; c++)
				{
					...
					else
					{
						...
						newNode.g = neighborG;
						newNode.h = DistEuclidian(newNode, mGoal);
			...
			if (solved)
			{
				...
				// Todos los intermedios excepto el comienzo
