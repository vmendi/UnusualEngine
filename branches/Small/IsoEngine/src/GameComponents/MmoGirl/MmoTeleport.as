package GameComponents.MmoGirl
{
	...
	public final class MmoTeleport extends GameComponent
	{
		...
		{
			TheGameModel.GlobalGameState.NextStartWorldPos = new Point3(NextStartPointX, NextStartPointY, NextStartPointZ);
			TheGameModel.GlobalGameState.NextOrientation = NextOrientation;
