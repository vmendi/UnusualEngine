package
{
	...
	public class IsoRenderer
	{
		...
		public function DrawGrid(cellSizeMeters : Number) : void
		{
			...
			var pos : Point = (mCamera != null)? mCamera.TargetPos : new Point(0,0);
		...
		{
			var prj00 : Point = (mCamera != null)? mCamera.IsoWorldToScreen(first) : IsoCamera.IsoProject(first);
			var prj01 : Point = (mCamera != null)? mCamera.IsoWorldToScreen(second) : IsoCamera.IsoProject(second);
