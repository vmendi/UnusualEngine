...
public class Main extends MovieClip
{
	...
	public function Main()
	{
		...
		myWiimote.addEventListener ( ButtonEvent.RIGHT_RELEASE, onRightRelease);
		myWiimote.addEventListener ( ButtonEvent.LEFT_RELEASE, onLeftRelease);
	...
	public function onRightRelease ( pEvt:ButtonEvent ):void
	...
	public function onLeftRelease ( pEvt:ButtonEvent ):void
	...
	private function init3D():void
	{
		...
		*/
		...
		rootNode.addCollada( "dae/Focus.dae", new MaterialsList( focusMaterials ) );
	...
	private function driveCar():void
	{
		...
		if( myWiimote.sensorX > 0 )
		{
			if( topSteer < 45 )
			{
				topSteer = Math.min( myWiimote.sensorX * 45, 45 );
			}
		}
		else if( myWiimote.sensorX < 0 )
		{
			if( topSteer > -45 )
			{
				topSteer = Math.max( myWiimote.sensorX * 45, -45 );
			}
		}
		else
		{
