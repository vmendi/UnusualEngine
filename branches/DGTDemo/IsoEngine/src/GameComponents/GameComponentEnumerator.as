package GameComponents
{
	...
	public final class GameComponentEnumerator implements IGameComponentEnumerator
	{
		...
		private function RegisterDesafiate() : void
		{
			...
			mComponentClasses.addItem(DesafiateBike as Class);
			...
			mComponentClasses.addItem(Puerta as Class);
			mComponentClasses.addItem(PuertaBike as Class);
			mComponentClasses.addItem(BicicletaSwitch as Class);
		}
