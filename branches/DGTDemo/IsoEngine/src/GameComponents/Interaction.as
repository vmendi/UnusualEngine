package GameComponents
{
	...
	public final class Interaction extends GameComponent
	{
		...
		private function OnMouseClick(event:MouseEvent):void
		{
			...
			TheGameModel.BroadcastMessage("OnClickInteraction", TheSceneObject);

			// Mandamos al personaje al punto de interaction
			if (NavigateOnClick && mCharacter && mCharacter.MouseControlled)
			{
		...
		private function OnNavigationEnd(event:Event) : void
		{
			...
			{
				mCharacter.TheVisualObject.gotoAndStop("idle"+FinalOrientation);
			}
