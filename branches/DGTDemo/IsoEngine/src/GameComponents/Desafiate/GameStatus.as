package GameComponents.Desafiate
{
	...
	public final class GameStatus extends GameComponent
	{
		...
		private function InitStatus() : void
		{
			...
			{
				mXMLStatus = new XML(Application.application.GetLastStatusFromServer());
			...
			else
			{
				...
				mGameStatus.Checkpoint = Checkpoints.INTER02;
		...
		public function SaveToServer() : void
		{
			...
			Application.application.SaveStatus(gameStatus.toXMLString());
		}
		...
		public function AddLogro(whichOne : String) : void
		{
			...
			Application.application.AddLogro(whichOne);
		}
		...
		public function AddGeekPoints(eventName:String, points : int) : void
		{
			...
			if (points != -1)
			{
				...
				Application.application.SavePuntuacion(eventName, points);
				Application.application.SavePuntuacion("GlobalScore", totalPoints);
			}
			else
			{
		...
		public function RestartGame():void
		{
			...
			Application.application.RestartGame(mGameStatus.Bag.Geekpoints);
		}
