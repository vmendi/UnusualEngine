...
//
// Revision:  1.1  Added closed loop support
//
...
/**
* @description 	Method: setOuterPoint( _flag:String, _xCoord:Number, _yCoord:Number ) - Add control point outside the knot range
*
...
*/
    public override function draw(_t:Number=1.0):void
    {
      ...
      g.moveTo(__x[1],__y[1]);
      for( var t:Number=deltaT; t<=p; t+=deltaT )
        g.lineTo(getX(t), getY(t)); 
        
      g.lineTo(getX(p), getY(p)); // handle likely roundoff error
    }
