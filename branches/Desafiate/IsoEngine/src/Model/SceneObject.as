package Model
{
	...
	public class SceneObject
	{
		...
		/** Nombre de la instancia en la escena, obtenido del DefaultGameComponent **/
		public function get Name() : String { return mAssetObj.TheDefaultGameComponent.Name; }
		...
		/**
		 * Chequea (pixel-perfect) si el punto está dentro de este TheVisualObject. Punto en espacio de stage.
		 */
		public function RealHitTest(point:Point) : Boolean
		{
            ...
            {
                var bmapData:BitmapData = new BitmapData(mVisualObject.width, mVisualObject.height, false, 0x00000000);
