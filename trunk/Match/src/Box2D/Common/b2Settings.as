...
public class b2Settings{
	...
	static public const b2_velocityThreshold:Number = 0.0;		// 1 m/s
	...
	//static public const b2_linearSleepTolerance:Number = 2;			// 1 cm/s
	static public const b2_linearSleepTolerance:Number = 8.0; //0.1;
	
	/// A body cannot sleep if its angular velocity is above this tolerance.
	//static public const b2_angularSleepTolerance:Number = 2.0 / 180.0;	// 2 degrees/s
	//static public const b2_angularSleepTolerance:Number = 120.0 / 180.0;	// 2 degrees/s
	static public const b2_angularSleepTolerance:Number = 10.0; //180.0 / 180.0; //30.0 / 180.0;
